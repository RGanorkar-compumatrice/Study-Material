...
/*
	...
	echo "hi skdmsld";
	require_once('/Rahul/bootstrap/PHPMailer_5.2.4/class.phpmailer.php');
define('GUSER', 'rahul@compumatrice.com'); // GMail username
define('GPWD', 'Pulsar180'); 
...
smtpmailer($mailpdf,"rahul@compumatrice.com","Rahul Ganorkar","testing email","this is mail for checking the sending of mail with attachment",$file_pdf_r);
*/
}
