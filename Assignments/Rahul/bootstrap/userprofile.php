...
<title><?php echo $findfriendname; ?></title>
...
<div class="bs-example" style="margin-top:-11px;width:1250px;margin-left:0px;height:70px;">
...
<select name="findfriendname"  style="margin-left:70px;margin-top:-48px;width:250px;" placeholder="Find Friends">
<?php $result1=mysqli_query($con,"SELECT * from login where id!='".$uid."'");
while($row=mysqli_fetch_array($result1))
  {
?>
...
$result6=mysqli_query($con," SELECT f.friend, u.imgfile, f.friendid FROM userfriendlist as f, upload as u where f.loginuserid='".$findfriendid."' and u.user_id=f.friendid");
 
 
while($row=mysqli_fetch_array($result6))
{
$findmutualfriend=$row['friendid'];
//$result12=mysqli_query($con,"select friend from userfriendlist where loginuserid='".$findmutualfriend."' and friendid!='".$uid."'");
//$counter5=mysqli_num_rows($result12);
?>
