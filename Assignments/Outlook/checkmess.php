...
$result=mysqli_query($con,"SELECT logid FROM friend WHERE name='".$toname."'");
...
$count=mysqli_query($con,"insert into message(message, loginid, datetime, toid) values 
('".$text."', '".$name."', '".$d."','".$sid."')");
...
$result1= mysqli_query($con,"SELECT f.name,m.message,m.datetime from friend as f,message as m where m.toid='".$name."' and m.loginid=f.logid and m.toid=f.user_id");
